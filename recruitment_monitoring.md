...
```r
# stylist registration
df_sr <- df_sr %>% filter(firstname_s != "#fname")
# df_ss <- df_ss %>% filter(`_id` != )

# stylist survey
df_ss <- df_ss %>% filter(firstname_s != "#fname")
# df_ss <- df_ss %>% filter(`_id` != )

# client registration
# df_cr <- df_cr %>% filter(`_id` != )

# client survey
# df_cs <- df_cs %>% filter(`_id` != )
```
