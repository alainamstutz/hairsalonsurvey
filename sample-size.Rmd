...
5) Estimate the intraclass correlation coefficient (ICC): The ICC measures the similarity or correlation between responses within the same cluster. Between 0-1. A higher ICC (closer to 1) implies more similarity, therefore smaller sample size needed (hence, the effective sample size is closer to the number of clusters as opposed to the entire sample size of study participants). Based on the ICC, the design effect (DEFF) is calculated.
